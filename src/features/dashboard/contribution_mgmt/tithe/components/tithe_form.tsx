...
const TitheForm = ({ open, setOpen, onSuccess }: TitheFormType) => {
    ...
    const onSubmit = (values: z.infer<typeof TitheSchema>) => {
        mutate(
            {
            ...
            },
            {
                ...
                onError: (error: any) => {
                    toast.error(error?.message ?? "Failed to record tithe");
                },
            }
        );
    };
    ...
    return (
        <main>
            <SideSheet
                ...
                title="Add New Tithe"
                description="Add a new Tithe to the church"
                footer={
