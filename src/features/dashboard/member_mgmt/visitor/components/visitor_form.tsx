...
const VisitorForm = ({ open, setOpen }: VisitorFormType) => {
    ...
    return (
        <main>
            <SideSheet open={open} onOpenChange={setOpen} title="Add New Visitor" description="Add a new visitor to the church"
                footer={
